...
CREATE TABLE `countries`( 
	`country_id` Char( 2 ) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
	`country_name` VarChar( 40 ) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
	`region_id` Int( 0 ) UNSIGNED NOT NULL,
...
CREATE TABLE `departments`( 
	`department_id` Int( 0 ) UNSIGNED NOT NULL,
	`department_name` VarChar( 30 ) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
	`manager_id` Int( 0 ) UNSIGNED NULL DEFAULT NULL,
	`location_id` Int( 0 ) UNSIGNED NULL DEFAULT NULL,
...
CREATE TABLE `job_history`( 
	...
	`job_id` VarChar( 10 ) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
	`department_id` Int( 0 ) UNSIGNED NOT NULL,
	CONSTRAINT `employee_id` UNIQUE( `employee_id`, `start_date` ) )
CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci
ENGINE = InnoDB;
-- -------------------------------------------------------------
...
CREATE TABLE `jobs`( 
	`job_id` VarChar( 10 ) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
	`job_title` VarChar( 35 ) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
CREATE TABLE `locations`( 
	`location_id` Int( 0 ) UNSIGNED AUTO_INCREMENT NOT NULL,
	`street_address` VarChar( 40 ) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
	`postal_code` VarChar( 12 ) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
	`city` VarChar( 30 ) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
	`state_province` VarChar( 25 ) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
	`country_id` Char( 2 ) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
CREATE TABLE `regions`( 
	`region_id` Int( 0 ) UNSIGNED NOT NULL,
	`region_name` VarChar( 25 ) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
...
CREATE INDEX `region_id` USING BTREE ON `countries`( `region_id` );
-- -------------------------------------------------------------


-- CREATE INDEX "location_id" ----------------------------------
CREATE INDEX `location_id` USING BTREE ON `departments`( `location_id` );
-- -------------------------------------------------------------


-- CREATE INDEX "manager_id" -----------------------------------
CREATE INDEX `manager_id` USING BTREE ON `departments`( `manager_id` );
-- -------------------------------------------------------------


-- CREATE INDEX "department_id" --------------------------------
CREATE INDEX `department_id` USING BTREE ON `employees`( `department_id` );
-- -------------------------------------------------------------


-- CREATE INDEX "job_id" ---------------------------------------
CREATE INDEX `job_id` USING BTREE ON `employees`( `job_id` );
-- -------------------------------------------------------------


-- CREATE INDEX "manager_id" -----------------------------------
CREATE INDEX `manager_id` USING BTREE ON `employees`( `manager_id` );
-- -------------------------------------------------------------


-- CREATE INDEX "department_id" --------------------------------
CREATE INDEX `department_id` USING BTREE ON `job_history`( `department_id` );
-- -------------------------------------------------------------


-- CREATE INDEX "job_id" ---------------------------------------
CREATE INDEX `job_id` USING BTREE ON `job_history`( `job_id` );
-- -------------------------------------------------------------


-- CREATE INDEX "country_id" -----------------------------------
CREATE INDEX `country_id` USING BTREE ON `locations`( `country_id` );
-- -------------------------------------------------------------


-- CREATE LINK "countries_ibfk_1" ------------------------------
ALTER TABLE `countries`
	ADD CONSTRAINT `countries_ibfk_1` FOREIGN KEY ( `region_id` )
...
-- CREATE LINK "departments_ibfk_1" ----------------------------
ALTER TABLE `departments`
	ADD CONSTRAINT `departments_ibfk_1` FOREIGN KEY ( `location_id` )
...
-- CREATE LINK "departments_ibfk_2" ----------------------------
ALTER TABLE `departments`
	ADD CONSTRAINT `departments_ibfk_2` FOREIGN KEY ( `manager_id` )
...
ALTER TABLE `employees`
	ADD CONSTRAINT `employees_ibfk_1` FOREIGN KEY ( `job_id` )
...
ALTER TABLE `employees`
	ADD CONSTRAINT `employees_ibfk_2` FOREIGN KEY ( `department_id` )
...
-- CREATE LINK "employees_ibfk_3" ------------------------------
ALTER TABLE `employees`
	ADD CONSTRAINT `employees_ibfk_3` FOREIGN KEY ( `manager_id` )
	REFERENCES `employees`( `employee_id` )
	ON DELETE No Action
	ON UPDATE No Action;
-- -------------------------------------------------------------
...
-- CREATE LINK "job_history_ibfk_1" ----------------------------
ALTER TABLE `job_history`
	ADD CONSTRAINT `job_history_ibfk_1` FOREIGN KEY ( `employee_id` )
	REFERENCES `employees`( `employee_id` )
	ON DELETE No Action
	ON UPDATE No Action;
-- -------------------------------------------------------------
...
-- CREATE LINK "job_history_ibfk_2" ----------------------------
ALTER TABLE `job_history`
	ADD CONSTRAINT `job_history_ibfk_2` FOREIGN KEY ( `job_id` )
	REFERENCES `jobs`( `job_id` )
	ON DELETE No Action
	ON UPDATE No Action;
-- -------------------------------------------------------------
...
-- CREATE LINK "job_history_ibfk_3" ----------------------------
ALTER TABLE `job_history`
	ADD CONSTRAINT `job_history_ibfk_3` FOREIGN KEY ( `department_id` )
	REFERENCES `departments`( `department_id` )
	ON DELETE No Action
	ON UPDATE No Action;
-- -------------------------------------------------------------
...
-- CREATE LINK "locations_ibfk_1" ------------------------------
ALTER TABLE `locations`
	ADD CONSTRAINT `locations_ibfk_1` FOREIGN KEY ( `country_id` )
...
CREATE ALGORITHM = UNDEFINED DEFINER = `root`@`localhost` SQL SECURITY DEFINER VIEW `emp_details_view`
